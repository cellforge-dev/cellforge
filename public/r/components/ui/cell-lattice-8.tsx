...
import { cx } from "@/components/ui/cellforge-core";
import { resolveDmxColorTokens } from "@/components/ui/cellforge-core";
import { styleOpacity, stylePx } from "@/components/ui/cellforge-core";
import { remapOpacityToTriplet } from "@/components/ui/cellforge-core";
import { dmxBloomHaloSpreadClass, dmxBloomRootActive, dmxDotBloomParts } from "@/components/ui/cellforge-core";
import { getPatternIndexes } from "@/components/ui/cellforge-core";
...
export type CellLattice8Props = CellForgeCommonProps;
...
export function CellLattice8({
  ...
  const { phase: matrixPhase, onMouseEnter, onMouseLeave } = useCellForgePhases({ animated: Boolean(animated && !reducedMotion), hoverAnimated: Boolean(hoverAnimated && !reducedMotion), speed });
